...
public class IntegerMaxValueObtainedByInsertingOne5DigitInsideDecimalRepresentationIntegerN {

    /*
    25. Wright a function solution that, given an integer N, returns the maximum possible value
    ...
    Assume that:
    *N is integer within the range [-8,000..8,000].
